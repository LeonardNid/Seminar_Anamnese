# WER-Analyse: Whisper Large-v3-turbo + gemma4
...
|-----------|-----------|-----------|---|---|---|-----------|-----|
| OriginalDC.m4a | 232 | 236 | 8 | 3 | 7 | 18 | **7.8%** |
| OriginalDCWhiteNoise.m4a | 229 | 210 | 59 | 27 | 8 | 94 | **41.0%** |
| OriginalLapInMitte.wav | 231 | 226 | 8 | 6 | 1 | 15 | **6.5%** |
| OriginalLapBeiArzt.wav | 226 | 230 | 12 | 2 | 6 | 20 | **8.8%** |
| SelbstkorrekturLapInMitte.wav | 183 | 201 | 11 | 0 | 18 | 29 | **15.8%** |
| UnterbrechungLapInMitte.wav | 153 | 143 | 8 | 11 | 1 | 20 | **13.1%** |
| GedankenprüngeLapInMitte.wav | 192 | 190 | 3 | 2 | 0 | 5 | **2.6%** |
| MeinungswechselLapinMitte.wav | 179 | 184 | 3 | 2 | 7 | 12 | **6.7%** |
| ChaosLapInMitte.wav | 272 | 252 | 15 | 24 | 4 | 43 | **15.8%** |
| Das Anamnesegespräch.wav | 2317 | 2271 | 77 | 67 | 21 | 165 | **7.1%** |
...
**WER: 7.8%** — Referenz: 232 Wörter | Hypothese: 236 Wörter | S=8 D=3 I=7 | Edit-Distanz=18
...
| 13 | Einfügung | *(nicht da)* | `was` | …auskultation der pulmones [___] … |
| 14 | Einfügung | *(nicht da)* | `kommt` | …auskultation der pulmones [___] … |
| 15 | Einfügung | *(nicht da)* | `jetzt` | …auskultation der pulmones [___] … |
| 16 | Einfügung | *(nicht da)* | `cosechs` | …auskultation der pulmones [___] … |
| 17 | Einfügung | *(nicht da)* | `speaker_` | …auskultation der pulmones [___] … |
| 18 | Einfügung | *(nicht da)* | `years` | …auskultation der pulmones [___] … |
...
**WER: 8.8%** — Referenz: 226 Wörter | Hypothese: 230 Wörter | S=12 D=2 I=6 | Edit-Distanz=20
...
| 17 | Einfügung | *(nicht da)* | `nichts` | …auskultation der pulmones [___] … |
| 18 | Einfügung | *(nicht da)* | `speaker_` | …auskultation der pulmones [___] … |
| 19 | Einfügung | *(nicht da)* | `einmal` | …auskultation der pulmones [___] … |
| 20 | Einfügung | *(nicht da)* | `ins` | …auskultation der pulmones [___] … |
...
**WER: 15.8%** — Referenz: 183 Wörter | Hypothese: 201 Wörter | S=11 D=0 I=18 | Edit-Distanz=29
...
| 16 | Einfügung | *(nicht da)* | `ich` | …bin extrem lichtempfindlich [___] … |
| 17 | Einfügung | *(nicht da)* | `habe` | …bin extrem lichtempfindlich [___] … |
| 18 | Einfügung | *(nicht da)* | `hier` | …bin extrem lichtempfindlich [___] … |
| 19 | Einfügung | *(nicht da)* | `einbezieht` | …bin extrem lichtempfindlich [___] … |
| 20 | Einfügung | *(nicht da)* | `speaker_` | …bin extrem lichtempfindlich [___] … |
| 21 | Einfügung | *(nicht da)* | `ich` | …bin extrem lichtempfindlich [___] … |
| 22 | Einfügung | *(nicht da)* | `habe` | …bin extrem lichtempfindlich [___] … |
| 23 | Einfügung | *(nicht da)* | `hier` | …bin extrem lichtempfindlich [___] … |
| 24 | Einfügung | *(nicht da)* | `einbeziehungsvolle` | …bin extrem lichtempfindlich [___] … |
| 25 | Einfügung | *(nicht da)* | `geht` | …bin extrem lichtempfindlich [___] … |
| 26 | Einfügung | *(nicht da)* | `im` | …bin extrem lichtempfindlich [___] … |
| 27 | Einfügung | *(nicht da)* | `meer` | …bin extrem lichtempfindlich [___] … |
| 28 | Einfügung | *(nicht da)* | `vielen` | …bin extrem lichtempfindlich [___] … |
| 29 | Einfügung | *(nicht da)* | `dank` | …bin extrem lichtempfindlich [___] … |
...
**WER: 6.7%** — Referenz: 179 Wörter | Hypothese: 184 Wörter | S=3 D=2 I=7 | Edit-Distanz=12
...
**WER: 7.1%** — Referenz: 2317 Wörter | Hypothese: 2271 Wörter | S=77 D=67 I=21 | Edit-Distanz=165
...
| 5 | Substitution | `e` | `westfalen` | …ja becken b [___] c k e… |
| 6 | Löschung | `c` | *(fehlt)* | …becken b e [___] k e n… |
...
| 11 | Löschung | `w` | *(fehlt)* | …n bindestrich westphalen [___] e s t… |
| 12 | Löschung | `e` | *(fehlt)* | …bindestrich westphalen w [___] s t p… |
| 13 | Löschung | `s` | *(fehlt)* | …westphalen w e [___] t p h… |
| 14 | Löschung | `t` | *(fehlt)* | …w e s [___] p h a… |
| 15 | Löschung | `p` | *(fehlt)* | …e s t [___] h a l… |
| 16 | Löschung | `h` | *(fehlt)* | …s t p [___] a l e… |
| 17 | Löschung | `a` | *(fehlt)* | …t p h [___] l e n… |
| 18 | Löschung | `l` | *(fehlt)* | …p h a [___] e n alles… |
| 19 | Löschung | `e` | *(fehlt)* | …h a l [___] n alles klar… |
| 20 | Löschung | `n` | *(fehlt)* | …a l e [___] alles klar danke… |
| 21 | Substitution | `danke` | `dankeschön` | …n alles klar [___] schön frau becken… |
| 22 | Löschung | `schön` | *(fehlt)* | …alles klar danke [___] frau becken westphalen… |
| 23 | Substitution | `westphalen` | `westfalen` | …schön frau becken [___] wie alt sind… |
| 24 | Substitution | `ah` | `oh` | …27 märz 1987 [___] schön herzlichen glückwunsch… |
| 25 | Substitution | `westphalen` | `westfalen` | …dank frau becken [___] wie groß sind… |
| 26 | Einfügung | *(nicht da)* | `speaker_` | …kilo glaube ich [___] gut können sie… |
| 27 | Substitution | `doktor` | `dr` | …ist der herr [___] becker der herr… |
| 28 | Substitution | `doktor` | `dr` | …becker der herr [___] becker wie der… |
| 29 | Substitution | `westphalen` | `westfalen` | …gut frau becken [___] sie wurden ja… |
| 30 | Einfügung | *(nicht da)* | `dabei` | …leider einen unfall [___] dabei habe ich… |
| 31 | Einfügung | *(nicht da)* | `habe` | …leider einen unfall [___] dabei habe ich… |
| 32 | Einfügung | *(nicht da)* | `ich` | …leider einen unfall [___] dabei habe ich… |
| 33 | Einfügung | *(nicht da)* | `mich` | …leider einen unfall [___] dabei habe ich… |
| 34 | Einfügung | *(nicht da)* | `verletzt` | …leider einen unfall [___] dabei habe ich… |
| 35 | Löschung | `beschmerzen` | *(fehlt)* | …denn jetzt für [___] beschmerzen beschwerden schuldigung… |
| 36 | Löschung | `beschmerzen` | *(fehlt)* | …jetzt für beschmerzen [___] beschwerden schuldigung haben… |
| 37 | Substitution | `schuldigung` | `entschuldigung` | …beschmerzen beschmerzen beschwerden [___] haben sie schmerzen… |
| 38 | Einfügung | *(nicht da)* | `wirklich` | …bewegen weil ich [___] schmerzen habe am… |
| 39 | Löschung | `ja` | *(fehlt)* | …habe am daumen [___] und er ist… |
| 40 | Substitution | `beides` | `weil` | …richtig stark verletzt [___] richtig geschwollen ist… |
| 41 | Einfügung | *(nicht da)* | `es` | …stark verletzt beides [___] geschwollen ist und… |
| 42 | Substitution | `wehtut` | `weh` | …und auch sehr [___] okay knie ist… |
| 43 | Einfügung | *(nicht da)* | `tut` | …auch sehr wehtut [___] knie ist auch… |
| 44 | Substitution | `westphalen` | `westfalen` | …genau frau becken [___] haben sie denn… |
| 45 | Substitution | `ungerne` | `ungern` | …dass ich sehr [___] einen fahrradhelm trage… |
| 46 | Substitution | `westphalen` | `westfalen` | …aussehen frau becken [___] bitte bitte tragen… |
| 47 | Substitution | `daraus` | `draus` | …ich habe jetzt [___] gelernt und werde… |
| 48 | Löschung | `am` | *(fehlt)* | …sie haben hinten [___] auf der linken… |
| 49 | Löschung | `das` | *(fehlt)* | …beule richtig genau [___] ist richtig ja… |
| 50 | Löschung | `ist` | *(fehlt)* | …richtig genau das [___] richtig ja haben… |
| 51 | Löschung | `richtig` | *(fehlt)* | …genau das ist [___] ja haben sie… |
| 52 | Löschung | `ja` | *(fehlt)* | …das ist richtig [___] haben sie irgendeine… |
| 53 | Substitution | `eins` | `1` | …einer schmerzskala wobei [___] sehr leichten schmerzen… |
| 54 | Substitution | `zehn` | `10` | …schmerzen entspricht und [___] sehr starken schmerzen… |
| 55 | Löschung | `den` | *(fehlt)* | …wo würden sie [___] daumen die schmerzen… |
| 56 | Löschung | `daumen` | *(fehlt)* | …würden sie den [___] die schmerzen des… |
| 57 | Substitution | `sieben` | `7` | …so auf die [___] zu vor allem… |
| 58 | Substitution | `stechend` | `stechen` | …sagen sehr stark [___] wenn ich versuche… |
| 59 | Substitution | `den` | `ihn` | …wenn ich versuche [___] zu bewegen okay… |
| 60 | Substitution | `acht` | `8` | …ich sagen bei [___] wenn ich sitze… |
| 61 | Löschung | `das` | *(fehlt)* | …aus nein das [___] zum glück nicht… |
| 62 | Substitution | `an` | `in` | …handgelenk aus oder [___] andere finger auch… |
| 63 | Substitution | `becken` | `beckenwestfalen` | …unfall erinnern frau [___] westphalen ich kann… |
| 64 | Löschung | `westphalen` | *(fehlt)* | …erinnern frau becken [___] ich kann mich… |
| 65 | Substitution | `dran` | `daran` | …kann mich gut [___] erinnern ja ich… |
| 66 | Einfügung | *(nicht da)* | `es` | …und mir war [___] schwindelig aber ich… |
| 67 | Substitution | `becken` | `beckenwestfalen` | …sehr gut frau [___] westphalen haben sie… |
| 68 | Löschung | `westphalen` | *(fehlt)* | …gut frau becken [___] haben sie irgendwelche… |
| 69 | Substitution | `laktose` | `laktoseintoleranz` | …ich hatte eine [___] intoleranz vor einigen… |
| 70 | Löschung | `intoleranz` | *(fehlt)* | …hatte eine laktose [___] vor einigen jahren… |
| 71 | Substitution | `dekollete` | `dekolleté` | …ausschlag hier im [___] bereich okay sonst… |
| 72 | Substitution | `becken` | `beckenwestfalen` | …sehr gut frau [___] westphalen sind sie… |
| 73 | Löschung | `westphalen` | *(fehlt)* | …gut frau becken [___] sind sie schon… |
| 74 | Substitution | `hallux` | `halux` | …mir wurde ein [___] valgus entfernt ein… |
| 75 | Substitution | `hallux` | `halux` | …valgus entfernt ein [___] valgus und welcher… |
| 76 | Substitution | `becken` | `beckenwestfalen` | …gut gelaufen frau [___] westphalen nehmen sie… |
| 77 | Löschung | `westphalen` | *(fehlt)* | …gelaufen frau becken [___] nehmen sie regelmäßig… |
| 78 | Substitution | `viel` | `viele` | …kopfschmerzen haben wie [___] milligramm sind das… |
| 79 | Substitution | `600er` | `600` | …ich glaube 600 [___] alles klar sind… |
| 80 | Substitution | `alles` | `ja` | …glaube 600 600er [___] klar sind sie… |
| 81 | Löschung | `klar` | *(fehlt)* | …600 600er alles [___] sind sie geimpft… |
| 82 | Löschung | `ja` | *(fehlt)* | …nein eher nicht [___] ich muss ins… |
| 83 | Löschung | `ich` | *(fehlt)* | …eher nicht ja [___] muss ins krankenhaus… |
| 84 | Löschung | `muss` | *(fehlt)* | …nicht ja ich [___] ins krankenhaus hätte… |
| 85 | Löschung | `ins` | *(fehlt)* | …ja ich muss [___] krankenhaus hätte ich… |
| 86 | Löschung | `krankenhaus` | *(fehlt)* | …ich muss ins [___] hätte ich gewusst… |
| 87 | Löschung | `hätte` | *(fehlt)* | …ins krankenhaus muss [___] ich ihn mitgenommen… |
| 88 | Löschung | `ich` | *(fehlt)* | …krankenhaus muss hätte [___] ihn mitgenommen ja… |
| 89 | Löschung | `ihn` | *(fehlt)* | …muss hätte ich [___] mitgenommen ja ich… |
| 90 | Löschung | `mitgenommen` | *(fehlt)* | …hätte ich ihn [___] ja ich muss… |
| 91 | Substitution | `muss` | `brauche` | …mitgenommen ja ich [___] auch gestehen dass… |
| 92 | Substitution | `auch` | `den` | …ja ich muss [___] gestehen dass ich… |
| 93 | Substitution | `gestehen` | `den` | …ich muss auch [___] dass ich ihn… |
| 94 | Löschung | `dass` | *(fehlt)* | …muss auch gestehen [___] ich ihn nicht… |
| 95 | Löschung | `ihn` | *(fehlt)* | …gestehen dass ich [___] nicht bei mir… |
| 96 | Substitution | `becken` | `beckenwestfalen` | …gut okay frau [___] westphalen wie geht… |
| 97 | Löschung | `westphalen` | *(fehlt)* | …okay frau becken [___] wie geht es… |
| 98 | Substitution | `hab` | `habe` | …zeit nein ich [___] gar keine sonstigen… |
| 99 | Substitution | `becken` | `beckenwestfalen` | …okay wunderbar frau [___] westphalen rauchen sie… |
| 100 | Löschung | `westphalen` | *(fehlt)* | …wunderbar frau becken [___] rauchen sie nein… |
| 101 | Löschung | `ja` | *(fehlt)* | …ist ja aber [___] wann haben sie… |
| 102 | Löschung | `wann` | *(fehlt)* | …ja aber ja [___] haben sie damit… |
| 103 | Löschung | `damit` | *(fehlt)* | …wann haben sie [___] aufgehört das müssten… |
| 104 | Einfügung | *(nicht da)* | `ach` | …sie damit aufgehört [___] müssten jetzt schon… |
| 105 | Substitution | `gläser` | `läser` | …zwei oder drei [___] okay dieses gläschen… |
| 106 | Substitution | `becken` | `beckenwestfalen` | …okay wunderbar frau [___] westphalen nehmen sie… |
| 107 | Löschung | `westphalen` | *(fehlt)* | …wunderbar frau becken [___] nehmen sie das… |
| 108 | Einfügung | *(nicht da)* | `okay` | …ritalin genommen habe [___] weil wir ein… |
| 109 | Substitution | `drei` | `dreimal` | …ja habe zwei [___] mal ritalin genommen… |
| 110 | Löschung | `mal` | *(fehlt)* | …habe zwei drei [___] ritalin genommen okay… |
| 111 | Substitution | `wars` | `war` | …genommen okay das [___] aber aber jetzt… |
| 112 | Substitution | `aber` | `es` | …okay das wars [___] aber jetzt schon… |
| 113 | Löschung | `jetzt` | *(fehlt)* | …wars aber aber [___] schon ja sehr… |
| 114 | Löschung | `schon` | *(fehlt)* | …aber aber jetzt [___] ja sehr gut… |
| 115 | Löschung | `gut` | *(fehlt)* | …gut okay prima [___] kurz zu ihrer… |
| 116 | Löschung | `okay` | *(fehlt)* | …großvater hatte leberzirrhose [___] und ist leider… |
| 117 | Substitution | `gestorben` | `geschrauben` | …leider auch daran [___] oh das tut… |
| 118 | Substitution | `brustkrebs` | `großkrebs` | …meine großmutter hatte [___] aber sie lebt… |
| 119 | Substitution | `becken` | `böcken` | …sie geschwister frau [___] westphalen ich habe… |
| 120 | Substitution | `westphalen` | `westfalen` | …geschwister frau becken [___] ich habe eine… |
| 121 | Substitution | `es` | `sie` | …ja sonst geht [___] ihr gut sehr… |
| 122 | Löschung | `ihr` | *(fehlt)* | …sonst geht es [___] gut sehr gut… |
| 123 | Substitution | `becken` | `böcken` | …sie kinder frau [___] westphalen nein ich… |
| 124 | Substitution | `westphalen` | `westfalen` | …kinder frau becken [___] nein ich habe… |
| 125 | Löschung | `okay` | *(fehlt)* | …habe keine kinder [___] wie sieht es… |
| 126 | Substitution | `bin` | `wenn` | …in einer marketingagentur [___] da für größere… |
| 127 | Einfügung | *(nicht da)* | `ich` | …einer marketingagentur bin [___] für größere kunden… |
| 128 | Einfügung | *(nicht da)* | `bin` | …und marketingprojekte zuständig [___] sehr gut eine… |
| 129 | Substitution | `becken` | `böcken` | …frage noch frau [___] westphalen waren sie… |
| 130 | Substitution | `westphalen` | `westfalen` | …noch frau becken [___] waren sie in… |
| 131 | Substitution | `becken` | `böcken` | …okay gut frau [___] westphalen von meiner… |
| 132 | Substitution | `westphalen` | `westfalen` | …gut frau becken [___] von meiner seite… |
| 133 | Substitution | `noch` | `nochmal` | …würde das gleich [___] mal mit ihnen… |
| 134 | Löschung | `mal` | *(fehlt)* | …das gleich noch [___] mit ihnen durchgehen… |
| 135 | Einfügung | *(nicht da)* | `so` | …sie dass es [___] schlimm wird oder… |
| 136 | Substitution | `erstmal` | `erst` | …müssen wir wirklich [___] mrt bilder von… |
| 137 | Einfügung | *(nicht da)* | `mal` | …wir wirklich erstmal [___] bilder von machen… |
| 138 | Löschung | `wir` | *(fehlt)* | …man abwägen ob [___] sie operieren oder… |
| 139 | Substitution | `noch` | `nochmal` | …würde auch gerne [___] mal eine untersuchung… |
| 140 | Löschung | `mal` | *(fehlt)* | …auch gerne noch [___] eine untersuchung mit… |
| 141 | Löschung | `dem` | *(fehlt)* | …wenn wir mit [___] mit der aufnahme… |
| 142 | Löschung | `mit` | *(fehlt)* | …wir mit dem [___] der aufnahme fertig… |
| 143 | Substitution | `nochmal` | `noch` | …ja alles klar [___] kurz zum abgleich… |
| 144 | Einfügung | *(nicht da)* | `mal` | …alles klar nochmal [___] zum abgleich sie… |
| 145 | Substitution | `sieben` | `7` | …dort mit einer [___] beschrieben und haben… |
| 146 | Substitution | `fürs` | `für` | …und gleiches gilt [___] knie auch das… |
| 147 | Einfügung | *(nicht da)* | `das` | …gleiches gilt fürs [___] auch das knie… |
| 148 | Substitution | `acht` | `8` | …schmerzintensität mit einer [___] beschrieben bei bewegung… |
| 149 | Substitution | `zehn` | `10` | …bewegung unerträglich also [___] oder mehr als… |
| 150 | Substitution | `zehn` | `10` | …oder mehr als [___] auch dieser schmerz… |
| 151 | Substitution | `leicht` | `recht` | …nur kurz danach [___] schwindelig war das… |
| 152 | Substitution | `war` | `waren` | …danach leicht schwindelig [___] das sei aber… |
| 153 | Substitution | `vorerkrankungen` | `vor` | …wieder vorbei genau [___] haben sie keine… |
| 154 | Einfügung | *(nicht da)* | `erkrankungen` | …vorbei genau vorerkrankungen [___] sie keine medikamente… |
| 155 | Substitution | `hallux` | `halux` | …da wurde der [___] valgus operiert ansonsten… |
| 156 | Löschung | `genau` | *(fehlt)* | …gott sei dank [___] bis auf die… |
| 157 | Substitution | `noch` | `nochmal` | …eingebracht vielen dank [___] mal dafür habe… |
| 158 | Löschung | `mal` | *(fehlt)* | …vielen dank noch [___] dafür habe ich… |
| 159 | Löschung | `genau` | *(fehlt)* | …ich mir notiert [___] es gibt ein… |
| 160 | Substitution | `becken` | `beckenwestfalen` | …sehr gut frau [___] westphalen dann war… |
| 161 | Löschung | `westphalen` | *(fehlt)* | …gut frau becken [___] dann war es… |
| 162 | Substitution | `danke` | `dagegen` | …warte dann hier [___] ihnen super besten… |
| 163 | Löschung | `ihnen` | *(fehlt)* | …dann hier danke [___] super besten dank… |
| 164 | Einfügung | *(nicht da)* | `bis` | …gleich bis gleich [___] … |
| 165 | Einfügung | *(nicht da)* | `gleich` | …gleich bis gleich [___] … |

# WER-Analyse: Whisper Large-v3-turbo + llama3.2
...
|-----------|-----------|-----------|---|---|---|-----------|-----|
| OriginalDC.m4a | 232 | 248 | 8 | 3 | 19 | 30 | **12.9%** |
| OriginalDCWhiteNoise.m4a | 229 | 210 | 59 | 27 | 8 | 94 | **41.0%** |
| OriginalLapInMitte.wav | 231 | 226 | 8 | 6 | 1 | 15 | **6.5%** |
| OriginalLapBeiArzt.wav | 226 | 231 | 12 | 2 | 7 | 21 | **9.3%** |
| SelbstkorrekturLapInMitte.wav | 183 | 190 | 11 | 0 | 7 | 18 | **9.8%** |
...
| Das Anamnesegespräch.wav | 2317 | 2270 | 76 | 60 | 13 | 149 | **6.4%** |
| Anamnesegesrpäch PWC.mp3 | 1530 | 1515 | 133 | 102 | 87 | 322 | **21.0%** |
...
**WER: 12.9%** — Referenz: 232 Wörter | Hypothese: 248 Wörter | S=8 D=3 I=19 | Edit-Distanz=30
...
| 13 | Einfügung | *(nicht da)* | `chicks` | …auskultation der pulmones [___] … |
| 14 | Einfügung | *(nicht da)* | `speaker_` | …auskultation der pulmones [___] … |
| 15 | Einfügung | *(nicht da)* | `da` | …auskultation der pulmones [___] … |
| 16 | Einfügung | *(nicht da)* | `dass` | …auskultation der pulmones [___] … |
| 17 | Einfügung | *(nicht da)* | `ihr` | …auskultation der pulmones [___] … |
| 18 | Einfügung | *(nicht da)* | `natürlich` | …auskultation der pulmones [___] … |
| 19 | Einfügung | *(nicht da)* | `verändert` | …auskultation der pulmones [___] … |
| 20 | Einfügung | *(nicht da)* | `im` | …auskultation der pulmones [___] … |
| 21 | Einfügung | *(nicht da)* | `acho` | …auskultation der pulmones [___] … |
| 22 | Einfügung | *(nicht da)* | `wir` | …auskultation der pulmones [___] … |
| 23 | Einfügung | *(nicht da)* | `pupitieren` | …auskultation der pulmones [___] … |
| 24 | Einfügung | *(nicht da)* | `kann` | …auskultation der pulmones [___] … |
| 25 | Einfügung | *(nicht da)* | `sie` | …auskultation der pulmones [___] … |
| 26 | Einfügung | *(nicht da)* | `dir` | …auskultation der pulmones [___] … |
| 27 | Einfügung | *(nicht da)* | `untertitelung` | …auskultation der pulmones [___] … |
| 28 | Einfügung | *(nicht da)* | `des` | …auskultation der pulmones [___] … |
| 29 | Einfügung | *(nicht da)* | `zdf` | …auskultation der pulmones [___] … |
| 30 | Einfügung | *(nicht da)* | `2020` | …auskultation der pulmones [___] … |
...
**WER: 9.3%** — Referenz: 226 Wörter | Hypothese: 231 Wörter | S=12 D=2 I=7 | Edit-Distanz=21
...
| 17 | Einfügung | *(nicht da)* | `das` | …auskultation der pulmones [___] … |
| 18 | Einfügung | *(nicht da)* | `ist` | …auskultation der pulmones [___] … |
| 19 | Einfügung | *(nicht da)* | `speaker_` | …auskultation der pulmones [___] … |
| 20 | Einfügung | *(nicht da)* | `vielen` | …auskultation der pulmones [___] … |
| 21 | Einfügung | *(nicht da)* | `dank` | …auskultation der pulmones [___] … |
...
**WER: 9.8%** — Referenz: 183 Wörter | Hypothese: 190 Wörter | S=11 D=0 I=7 | Edit-Distanz=18
...
| 16 | Einfügung | *(nicht da)* | `ja` | …bin extrem lichtempfindlich [___] … |
| 17 | Einfügung | *(nicht da)* | `das` | …bin extrem lichtempfindlich [___] … |
| 18 | Einfügung | *(nicht da)* | `ist` | …bin extrem lichtempfindlich [___] … |
...
**WER: 6.4%** — Referenz: 2317 Wörter | Hypothese: 2270 Wörter | S=76 D=60 I=13 | Edit-Distanz=149
...
| 24 | Löschung | `33` | *(fehlt)* | …sie denn 33 [___] und wann ist… |
| 25 | Löschung | `ah` | *(fehlt)* | …27 märz 1987 [___] schön herzlichen glückwunsch… |
| 26 | Substitution | `westphalen` | `westfalen` | …dank frau becken [___] wie groß sind… |
| 27 | Einfügung | *(nicht da)* | `speaker_` | …kilo glaube ich [___] gut können sie… |
| 28 | Substitution | `doktor` | `dr` | …ist der herr [___] becker der herr… |
| 29 | Substitution | `doktor` | `dr` | …becker der herr [___] becker wie der… |
| 30 | Substitution | `westphalen` | `westfalen` | …gut frau becken [___] sie wurden ja… |
| 31 | Substitution | `beschmerzen` | `beschwerden` | …denn jetzt für [___] beschmerzen beschwerden schuldigung… |
| 32 | Löschung | `beschmerzen` | *(fehlt)* | …jetzt für beschmerzen [___] beschwerden schuldigung haben… |
| 33 | Substitution | `schuldigung` | `entschuldigung` | …beschmerzen beschmerzen beschwerden [___] haben sie schmerzen… |
| 34 | Substitution | `in` | `an` | …kopf im oberkörper [___] den beinen ja… |
| 35 | Einfügung | *(nicht da)* | `wirklich` | …bewegen weil ich [___] schmerzen habe am… |
| 36 | Löschung | `ja` | *(fehlt)* | …habe am daumen [___] und er ist… |
| 37 | Substitution | `beides` | `weil` | …richtig stark verletzt [___] richtig geschwollen ist… |
| 38 | Einfügung | *(nicht da)* | `es` | …stark verletzt beides [___] geschwollen ist und… |
| 39 | Substitution | `wehtut` | `weh` | …und auch sehr [___] okay knie ist… |
| 40 | Einfügung | *(nicht da)* | `tut` | …auch sehr wehtut [___] knie ist auch… |
| 41 | Substitution | `westphalen` | `westfalen` | …genau frau becken [___] haben sie denn… |
| 42 | Substitution | `ungerne` | `ungern` | …dass ich sehr [___] einen fahrradhelm trage… |
| 43 | Substitution | `westphalen` | `westfalen` | …aussehen frau becken [___] bitte bitte tragen… |
| 44 | Löschung | `am` | *(fehlt)* | …sie haben hinten [___] auf der linken… |
| 45 | Substitution | `eins` | `1` | …einer schmerzskala wobei [___] sehr leichten schmerzen… |
| 46 | Substitution | `zehn` | `10` | …schmerzen entspricht und [___] sehr starken schmerzen… |
| 47 | Löschung | `den` | *(fehlt)* | …wo würden sie [___] daumen die schmerzen… |
| 48 | Löschung | `daumen` | *(fehlt)* | …würden sie den [___] die schmerzen des… |
| 49 | Substitution | `sieben` | `7` | …so auf die [___] zu vor allem… |
| 50 | Substitution | `acht` | `8` | …ich sagen bei [___] wenn ich sitze… |
| 51 | Löschung | `das` | *(fehlt)* | …aus nein das [___] zum glück nicht… |
| 52 | Substitution | `an` | `in` | …handgelenk aus oder [___] andere finger auch… |
| 53 | Substitution | `becken` | `beckenwestfalen` | …unfall erinnern frau [___] westphalen ich kann… |
| 54 | Löschung | `westphalen` | *(fehlt)* | …erinnern frau becken [___] ich kann mich… |
| 55 | Substitution | `dran` | `daran` | …kann mich gut [___] erinnern ja ich… |
| 56 | Einfügung | *(nicht da)* | `es` | …und mir war [___] schwindelig aber ich… |
| 57 | Substitution | `noch` | `nochmal` | …oder vielleicht doch [___] mal schwarz vor… |
| 58 | Löschung | `mal` | *(fehlt)* | …vielleicht doch noch [___] schwarz vor augen… |
| 59 | Löschung | `wie` | *(fehlt)* | …und dass ich [___] gesagt am anfang… |
| 60 | Löschung | `gesagt` | *(fehlt)* | …dass ich wie [___] am anfang nur… |
| 61 | Substitution | `becken` | `beckenwestfalen` | …sehr gut frau [___] westphalen haben sie… |
| 62 | Löschung | `westphalen` | *(fehlt)* | …gut frau becken [___] haben sie irgendwelche… |
| 63 | Substitution | `laktose` | `laktoseintoleranz` | …ich hatte eine [___] intoleranz vor einigen… |
| 64 | Löschung | `intoleranz` | *(fehlt)* | …hatte eine laktose [___] vor einigen jahren… |
| 65 | Löschung | `ja` | *(fehlt)* | …allerdings schon weg [___] und jetzt wurde… |
| 66 | Substitution | `dekollete` | `dekolleté` | …ausschlag hier im [___] bereich okay sonst… |
| 67 | Einfügung | *(nicht da)* | `nein` | …keine vorerkrankungen nein [___] sehr gut frau… |
| 68 | Substitution | `becken` | `beckenwestfalen` | …sehr gut frau [___] westphalen sind sie… |
| 69 | Löschung | `westphalen` | *(fehlt)* | …gut frau becken [___] sind sie schon… |
| 70 | Substitution | `hallux` | `halux` | …mir wurde ein [___] valgus entfernt ein… |
| 71 | Substitution | `hallux` | `halux` | …valgus entfernt ein [___] valgus und welcher… |
| 72 | Substitution | `becken` | `beckenwestfalen` | …gut gelaufen frau [___] westphalen nehmen sie… |
| 73 | Löschung | `westphalen` | *(fehlt)* | …gelaufen frau becken [___] nehmen sie regelmäßig… |
| 74 | Substitution | `viel` | `viele` | …kopfschmerzen haben wie [___] milligramm sind das… |
| 75 | Substitution | `600er` | `600` | …ich glaube 600 [___] alles klar sind… |
| 76 | Einfügung | *(nicht da)* | `ja` | …glaube 600 600er [___] klar sind sie… |
| 77 | Löschung | `ja` | *(fehlt)* | …nein eher nicht [___] ich muss ins… |
| 78 | Löschung | `ich` | *(fehlt)* | …eher nicht ja [___] muss ins krankenhaus… |
| 79 | Löschung | `muss` | *(fehlt)* | …nicht ja ich [___] ins krankenhaus hätte… |
| 80 | Löschung | `ins` | *(fehlt)* | …ja ich muss [___] krankenhaus hätte ich… |
| 81 | Löschung | `krankenhaus` | *(fehlt)* | …ich muss ins [___] hätte ich gewusst… |
| 82 | Löschung | `hätte` | *(fehlt)* | …ins krankenhaus muss [___] ich ihn mitgenommen… |
| 83 | Löschung | `ich` | *(fehlt)* | …krankenhaus muss hätte [___] ihn mitgenommen ja… |
| 84 | Löschung | `ihn` | *(fehlt)* | …muss hätte ich [___] mitgenommen ja ich… |
| 85 | Löschung | `mitgenommen` | *(fehlt)* | …hätte ich ihn [___] ja ich muss… |
| 86 | Substitution | `gestehen` | `wissen` | …ich muss auch [___] dass ich ihn… |
| 87 | Substitution | `ihn` | `den` | …gestehen dass ich [___] nicht bei mir… |
| 88 | Löschung | `ja` | *(fehlt)* | …bei mir trage [___] sehr gut okay… |
| 89 | Substitution | `becken` | `beckenwestfalen` | …gut okay frau [___] westphalen wie geht… |
| 90 | Löschung | `westphalen` | *(fehlt)* | …okay frau becken [___] wie geht es… |
| 91 | Substitution | `hab` | `habe` | …zeit nein ich [___] gar keine sonstigen… |
| 92 | Substitution | `becken` | `beckenwestfalen` | …okay wunderbar frau [___] westphalen rauchen sie… |
| 93 | Löschung | `westphalen` | *(fehlt)* | …wunderbar frau becken [___] rauchen sie nein… |
| 94 | Substitution | `aber` | `wie` | …relevant ist ja [___] ja wann haben… |
| 95 | Substitution | `ja` | `lange` | …ist ja aber [___] wann haben sie… |
| 96 | Löschung | `wann` | *(fehlt)* | …ja aber ja [___] haben sie damit… |
| 97 | Löschung | `damit` | *(fehlt)* | …wann haben sie [___] aufgehört das müssten… |
| 98 | Einfügung | *(nicht da)* | `ach` | …sie damit aufgehört [___] müssten jetzt schon… |
| 99 | Substitution | `gläser` | `gäser` | …zwei oder drei [___] okay dieses gläschen… |
| 100 | Substitution | `becken` | `beckenwestfalen` | …okay wunderbar frau [___] westphalen nehmen sie… |
| 101 | Löschung | `westphalen` | *(fehlt)* | …wunderbar frau becken [___] nehmen sie das… |
| 102 | Substitution | `drei` | `dreimal` | …ja habe zwei [___] mal ritalin genommen… |
| 103 | Löschung | `mal` | *(fehlt)* | …habe zwei drei [___] ritalin genommen okay… |
| 104 | Substitution | `wars` | `war` | …genommen okay das [___] aber aber jetzt… |
| 105 | Substitution | `aber` | `es` | …okay das wars [___] aber jetzt schon… |
| 106 | Substitution | `jetzt` | `ja` | …wars aber aber [___] schon ja sehr… |
| 107 | Löschung | `schon` | *(fehlt)* | …aber aber jetzt [___] ja sehr gut… |
| 108 | Löschung | `okay` | *(fehlt)* | …großvater hatte leberzirrhose [___] und ist leider… |
| 109 | Substitution | `gestorben` | `geschrauben` | …leider auch daran [___] oh das tut… |
| 110 | Substitution | `brustkrebs` | `großkrebs` | …meine großmutter hatte [___] aber sie lebt… |
| 111 | Substitution | `becken` | `böcken` | …sie geschwister frau [___] westphalen ich habe… |
| 112 | Substitution | `westphalen` | `westfalen` | …geschwister frau becken [___] ich habe eine… |
| 113 | Substitution | `es` | `sie` | …ja sonst geht [___] ihr gut sehr… |
| 114 | Löschung | `ihr` | *(fehlt)* | …sonst geht es [___] gut sehr gut… |
| 115 | Substitution | `becken` | `böcken` | …sie kinder frau [___] westphalen nein ich… |
| 116 | Substitution | `westphalen` | `westfalen` | …kinder frau becken [___] nein ich habe… |
| 117 | Substitution | `bin` | `wenn` | …in einer marketingagentur [___] da für größere… |
| 118 | Einfügung | *(nicht da)* | `sind` | …und marketingprojekte zuständig [___] sehr gut eine… |
| 119 | Substitution | `becken` | `böcken` | …frage noch frau [___] westphalen waren sie… |
| 120 | Substitution | `westphalen` | `westfalen` | …noch frau becken [___] waren sie in… |
| 121 | Substitution | `becken` | `böcken` | …okay gut frau [___] westphalen von meiner… |
| 122 | Substitution | `westphalen` | `westfalen` | …gut frau becken [___] von meiner seite… |
| 123 | Substitution | `noch` | `nochmal` | …würde das gleich [___] mal mit ihnen… |
| 124 | Löschung | `mal` | *(fehlt)* | …das gleich noch [___] mit ihnen durchgehen… |
| 125 | Einfügung | *(nicht da)* | `so` | …sie dass es [___] schlimm wird oder… |
| 126 | Substitution | `noch` | `nochmal` | …würde auch gerne [___] mal eine untersuchung… |
| 127 | Löschung | `mal` | *(fehlt)* | …auch gerne noch [___] eine untersuchung mit… |
| 128 | Löschung | `dem` | *(fehlt)* | …wenn wir mit [___] mit der aufnahme… |
| 129 | Löschung | `mit` | *(fehlt)* | …wir mit dem [___] der aufnahme fertig… |
| 130 | Löschung | `ja` | *(fehlt)* | …auch gleich los [___] alles klar nochmal… |
| 131 | Substitution | `nochmal` | `noch` | …ja alles klar [___] kurz zum abgleich… |
| 132 | Einfügung | *(nicht da)* | `mal` | …alles klar nochmal [___] zum abgleich sie… |
| 133 | Substitution | `sieben` | `7` | …dort mit einer [___] beschrieben und haben… |
| 134 | Substitution | `fürs` | `für` | …und gleiches gilt [___] knie auch das… |
| 135 | Einfügung | *(nicht da)* | `das` | …gleiches gilt fürs [___] auch das knie… |
| 136 | Substitution | `acht` | `8` | …schmerzintensität mit einer [___] beschrieben bei bewegung… |
| 137 | Substitution | `zehn` | `10` | …bewegung unerträglich also [___] oder mehr als… |
| 138 | Substitution | `zehn` | `10` | …oder mehr als [___] auch dieser schmerz… |
| 139 | Löschung | `richtig` | *(fehlt)* | …knie geschwollen richtig [___] sie haben gesagt… |
| 140 | Substitution | `leicht` | `recht` | …nur kurz danach [___] schwindelig war das… |
| 141 | Substitution | `war` | `waren` | …danach leicht schwindelig [___] das sei aber… |
| 142 | Substitution | `hallux` | `halux` | …da wurde der [___] valgus operiert ansonsten… |
| 143 | Löschung | `genau` | *(fehlt)* | …gott sei dank [___] bis auf die… |
| 144 | Substitution | `histaminunverträglichkeit` | `kistaminunverträglichkeit` | …bis auf die [___] genau das hätte… |
| 145 | Substitution | `noch` | `nochmal` | …eingebracht vielen dank [___] mal dafür habe… |
| 146 | Löschung | `mal` | *(fehlt)* | …vielen dank noch [___] dafür habe ich… |
| 147 | Substitution | `westphalen` | `westfalen` | …gut frau becken [___] dann war es… |
| 148 | Substitution | `danke` | `vielen` | …warte dann hier [___] ihnen super besten… |
| 149 | Einfügung | *(nicht da)* | `dank` | …dann hier danke [___] super besten dank… |
...
**WER: 21.0%** — Referenz: 1530 Wörter | Hypothese: 1515 Wörter | S=133 D=102 I=87 | Edit-Distanz=322
